...
<div class="max-w-md mx-auto bg-[#1F2937] p-8 rounded-xl shadow-lg">
    <h2 class="text-3xl font-bold text-[#C62828] mb-6">Sign Up for Poker Club</h2>
    ...
    <form action="{{ route('register') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="w-full p-3 mt-2 rounded-lg bg-[#263238] text-white" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <input type="password" name="password_confirmation" id="password_confirmation" class="w-full p-3 mt-2 rounded-lg bg-[#263238] text-white" required>
        </div>

        <div class="mb-4">
            <label for="role" class="block text-gray-300">Role</label>
            <select name="role" id="role" class="w-full p-3 mt-2 rounded-lg bg-[#263238] text-white" required>
        ...
        <button type="submit" class="w-full p-3 bg-[#C62828] text-white rounded-lg mt-4">Sign Up</button>
    </form>

    <p class="mt-6 text-gray-300 text-center">
        Already have an account? <a href="{{ route('login') }}" class="text-[#C62828] hover:text-[#FF7043]">Log in here</a>.
    </p>
</div>
@endsection
